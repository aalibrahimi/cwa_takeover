/**
 * SetPasswordForm.tsx — the interactive form rendered inside the
 * /auth/set-password route's Suspense boundary.
 *
 * Lives here rather than directly in page.tsx because
 * useSearchParams() requires a <Suspense> boundary in Next.js 15+,
 * and wrapping at the page level means keeping the page component
 * free of client-only hooks. See page.tsx for the wrapper.
 */
