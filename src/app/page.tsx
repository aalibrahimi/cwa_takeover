...
const features = [
  {
    title: "Team Chat",
    description: "Real-time messaging with teammates across projects and departments",
    icon: MessageCircle,
    color: "from-red-600 to-red-800"
  },
  {
    title: "Smart Scheduling",
    description: "Intelligent calendar management with conflict resolution and reminders",
    icon: Calendar,
    color: "from-red-700 to-red-900"
  },
  {
    title: "Task Management",
    description: "Assign, track, and complete tasks with deadline monitoring and priority levels",
    icon: CheckSquare,
    color: "from-red-800 to-red-950"
  },
  {
    title: "Team Collaboration",
    description: "Create teams, assign members and set permissions for different projects",
    icon: Users,
    color: "from-red-600 to-red-800"
  },
  {
    title: "Smart Notifications",
    description: "Customizable alerts for messages, task updates, and important deadlines",
    icon: Bell,
    color: "from-red-700 to-red-900"
  },
  {
    title: "Advanced Analytics",
    description: "Real-time performance metrics for teams, projects, and individual tasks",
    icon: BarChart3,
    color: "from-red-800 to-red-950"
  }
];
...
const testimonials = [
  {
    ...
    content: "Takeover has completely transformed how our team collaborates. The seamless integration between chat and task management is a game-changer."
  },
  {
    name: "Sarah Chen",
    position: "Team Lead",
    content: "The scheduling features alone have saved us countless hours of back-and-forth. Takeover has become essential to our daily workflow."
  },
  {
    name: "Marcus Johnson",
    position: "Director of Operations",
    content: "The analytics dashboard gives me instant visibility into team performance. I can identify bottlenecks and optimize workflows in real-time."
  }
];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex flex-col p-4 space-y-4">
                ...
                <MobileNavLink href="#download" onClick={() => setIsMenuOpen(false)}>
                  Download
                </MobileNavLink>
              </div>
            </motion.div>
            ...
            <div>
              ...
              >
                ...
                <p className="text-lg md:text-xl text-red-200/80 mb-8 max-w-xl">
                  The all-in-one workspace for teams to chat, schedule, and manage tasks
                  with intelligent features that streamline your workflow.
                </p>
              ...
              <div className="relative bg-black/60 border border-red-950/30 rounded-xl overflow-hidden shadow-2xl shadow-red-950/20">
                <div className="p-1 bg-gradient-to-r from-red-950 to-red-900/20">
                  <div className="flex items-center space-x-2 px-3 py-1">
                    ...
                    <div className="text-xs text-red-400/60 ml-2">Takeover App</div>
                  </div>
                </div>
                <div className="p-4">
                  <div className="grid grid-cols-12 gap-4 h-80">
                    ...
                    <div className="col-span-9 bg-black/40 border border-red-950/20 rounded-lg flex flex-col">
                      <div className="border-b border-red-950/20 p-3 flex justify-between items-center">
                        <span className="text-red-400 font-medium">Project Dashboard</span>
                      ...
                      <div className="p-3 flex-1 flex flex-col">
                        <div className="grid grid-cols-2 gap-3 mb-3">
                          <div className="bg-gradient-to-br from-red-950/30 to-red-900/10 rounded p-3">
                            <div className="text-xs text-red-400/60 mb-1">Active Tasks</div>
                            <div className="text-xl font-bold text-red-300">24</div>
                          </div>
                          <div className="bg-gradient-to-br from-red-950/30 to-red-900/10 rounded p-3">
                            <div className="text-xs text-red-400/60 mb-1">Completed</div>
                            <div className="text-xl font-bold text-red-300">18</div>
                          </div>
                        </div>
                        <div className="flex-1 bg-black/20 rounded-lg p-2 overflow-hidden">
                          <div className="space-y-2">
                            {["Website Redesign", "Content Strategy", "App Release"].map((task) => (
                              <div 
                                key={task} 
                                className="px-3 py-2 bg-black/30 border border-red-950/20 rounded flex justify-between items-center"
                              >
                                <span className="text-sm text-red-200">{task}</span>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-red-200/60 text-lg max-w-2xl mx-auto">
                Takeover combines all the tools your team needs in one intuitive platform,
                eliminating app-switching and streamlining your workflow.
              </p>
            </motion.div>
          </div>
              ...
              >
                <Card className="bg-black/60 border-red-950/30 backdrop-blur-sm h-full overflow-hidden group">
                  <CardContent className="p-6 flex flex-col h-full">
                    <div className="mb-5">
                      <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${feature.color} p-3 mb-4 transform group-hover:scale-110 transition-transform`}>
            ...
            {[
              {
                ...
                description: "Invite team members, create departments, and establish your organizational structure.",
                icon: Users
              },
              {
                number: "02",
                title: "Set Up Projects",
                description: "Create projects, define milestones, and assign team members to specific tasks.",
                icon: CheckSquare
              },
              {
                number: "03",
                title: "Work Smarter",
                description: "Communicate, plan, and execute in one place with real-time updates and smart notifications.",
                icon: Bell
              }
            ].map((step, index) => (
              <motion.div
      ...
      {/* Download Section */}
      <section id="download" className="py-20 md:py-32 bg-gradient-to-b from-black to-red-950/20 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 lg:px-12 relative z-10">
          <div className="text-center mb-12">
            ...
            >
              ...
              <p className="text-red-200/60 text-lg max-w-2xl mx-auto">
                Download Takeover today and transform how your team works together.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-red-200/60 mb-6">
                  Takeover works seamlessly across desktop and mobile, with native
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {["Documentation", "Help Center", "Community", "Security", "Privacy"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-red-200/60 hover:text-red-300 transition-colors">
                      {item}
                    </a>
